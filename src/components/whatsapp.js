    ...
    <div className="col-lg-6 whatsapp-text">
      <Fade bottom>
        <div className={'whatsapp-bubble'}> 
            ...
            <a href="https://api.whatsapp.com/send?l=ca&phone=34607812839&text=Vull%20rebre%20informaci%C3%B3%20de%20Comprom%C3%ADs%20Val%C3%A8ncia%20al%20meu%20WhatsApp&source=&data=" className={'whatsapp-button'}><FaWhatsapp className="icon" /> <FormattedMessage id="whatsapp_cta" /></a>
        </div>
      </Fade>
    </div>
    <Fade>
